...
def task_summarize_GFSFALCS(
        depends_on=BLD_data / ".dir_created",
        produces=BLD_data / "Summaries" / "GFSFALCS" / "aggregated_summary_GFSFALCS.csv"
):
    """Task to summarize GFSFALCS data."""
    # Define directories
    data_dir = SRC / "data" / "GFSFALCS"
    output_dir = BLD_data / "Summaries" / "GFSFALCS"
