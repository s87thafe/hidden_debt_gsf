...
def task_summarize_GFSMAB(
        depends_on=BLD_data / ".dir_created",
        produces=BLD_data / "Summaries" / "GFSMAB" / "aggregated_summary_GFSMAB.csv"
):
    """Task to summarize MAB data."""
    # Define directories
    data_dir = SRC / "data" / "GFSMAB"
    output_dir = BLD_data / "Summaries" / "GFSMAB"
