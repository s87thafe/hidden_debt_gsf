...
def task_most_populated_combinations_gfsmab(
        depends_on=BLD_data / "Parquet" / "GFSMAB" / "filtered_merged_gsfmab.parquet",
        produces=BLD_data / "DTA" / "GFSMAB" / "most_populated_float.dta"
):
    """
